...
exports.seedApartments = void 0;
const model_1 = require("./model");
// Seed initial data
const seedApartments = async () => {
    try {
        const count = await model_1.ApartmentModel.countDocuments();
        ...
        await model_1.ApartmentModel.insertMany(apartments);
...
exports.seedApartments = seedApartments;
